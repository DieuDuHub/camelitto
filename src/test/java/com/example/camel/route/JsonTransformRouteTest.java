...
class JsonTransformRouteTest {
    ...
    @Test
    void testJsonTransformProcessorDirectly() throws Exception {
        // Test direct du processeur de transformation
        String inputJson = "{\"id\":1,\"title\":\"test title\",\"body\":\"test body content\",\"userId\":123}";
        
        JsonTransformRoute.JsonTransformProcessor processor = new JsonTransformRoute.JsonTransformProcessor();
        ...
        assertTrue(result.contains("\"originalId\":1"));
        assertTrue(result.contains("TRANSFORMED: TEST TITLE"));
        assertTrue(result.contains("transformationTimestamp"));
    ...
    void testPersonDataProcessorDirectly() throws Exception {
        ...
        JsonTransformRoute.PersonDataProcessor processor = new JsonTransformRoute.PersonDataProcessor();
